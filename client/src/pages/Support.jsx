        ...
        <div className='flex w-2/5 items-center flex-col border self-center justify-center border-zinc-600 rounded-md gap-4 px-6 py-5'>
          ...
          <div class="flex items-center ">
            <input id="default-radio-1" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 "/>
              <label for="default-radio-1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree to <span className="text-blue-500">FarmEase's terms of use</span></label>
          </div>
